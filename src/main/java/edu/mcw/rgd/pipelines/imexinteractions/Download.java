...
public class Download {
    ...
    public String download2File(List<String> allSpecies, String fileName) throws Exception {
        ...
        try( OutputStream outputStream = new GZIPOutputStream(new BufferedOutputStream(new FileOutputStream(outfilename))) ) {
    ...
    public List<String> getImexDbUrls() throws Exception {
        ...
        try {
            ...
            if(responseCode==200){
                ...
                try( BufferedReader br = new BufferedReader(new InputStreamReader(registryConnection.getInputStream())) ) {
                    String line;
